...
- 5f0f21f: feat: enhance init command scaffold and protect workspace credentials in config
...
- 7ec553a: Refactor CLI internals: extract shared resolveWorkspace utility, narrow createClientFn types using Pick, remove index signature from CachedDocument, and deduplicate default fsApi in cache module
